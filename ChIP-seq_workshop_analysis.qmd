...
Here is a pipeline containing everything up to that point; [pipeline.sh](http://bifx-core.bio.ed.ac.uk/training/ChIP-seq_workshop/pipeline.sh)
...
[analysis/sh](http://bifx-core.bio.ed.ac.uk/training/ChIP-seq_workshop/analysis.sh)
